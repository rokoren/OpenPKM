...
public class MarkdownCssThemeProvider implements MarkdownThemeProvider
{
    private static final String CATEGORY = "Markdown CSS";
    ...
    public enum Theme implements MarkdownTheme
    {
        ...
        {
            return Lookup.getDefault().lookup(MarkdownCssThemeProvider.class);
        }         
