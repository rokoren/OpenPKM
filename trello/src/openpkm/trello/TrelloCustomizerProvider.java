 ...
 * @author Rok Koren
 */
public class TrelloCustomizerProvider implements CustomizerProvider
{
    public final TrelloProject project;

    public static final String CUSTOMIZER_FOLDER_PATH = "Projects/openpkm-trello-project/Customizer";

    public TrelloCustomizerProvider(TrelloProject project)
    {
