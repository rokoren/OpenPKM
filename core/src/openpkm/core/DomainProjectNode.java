 ...
 * @author Rok Koren
 */
public class DomainProjectNode extends FilterNode implements ChangeListener, PropertyChangeListener
{       
    private static final Logger LOG = Logger.getLogger(DomainProjectNode.class.getName());          
    
    final DomainProject project;

    public DomainProjectNode(Node node, DomainProject project) throws DataObjectNotFoundException {
    ...
    {
        if(evt.getSource() instanceof KnowledgeGraphProvider)
        {
