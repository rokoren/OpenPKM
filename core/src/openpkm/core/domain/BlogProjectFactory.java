...
public class BlogProjectFactory implements ProjectFactory
{
    public static final String PROJECT_FOLDER = "openpkm-blog-project"; 
    public static final String PROJECT_FILE   = "project.properties";      
    
    private static final Logger LOG = Logger.getLogger(BlogProjectFactory.class.getName());     
    ...
    public Project loadProject(FileObject dir,  ProjectState state) throws IOException 
    {
        if (isProject(dir))
        {
            ...
            return new BlogProject(dir, state, props);   
        }       
        return null;          
    }    
    ...
    public void saveProject(Project project) throws IOException, ClassCastException 
    {
        ...
        {            
            ...
            provider.getProperties().store(os, "Blog project updated");
            os.close();   
        }  
    }     
}
