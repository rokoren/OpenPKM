 ...
 */
@ConvertAsProperties(
        dtd = "-//openpkm.core.domain//Twitter//EN",
        autostore = false
)
...
@ActionID(category = "Window", id = "openpkm.core.domain.TwitterTopComponent")
...
{    
    ...
    public TwitterTopComponent() 
    {
        initComponents();
        setName(Bundle.CTL_TwitterTopComponent());
        setToolTipText(Bundle.HINT_TwitterTopComponent());
