...
public class FacebookProjectFactory implements ProjectFactory
{
    public static final String PROJECT_FOLDER = "openpkm-facebook-project"; 
    public static final String PROJECT_FILE   = "project.properties";      
    
    private static final Logger LOG = Logger.getLogger(FacebookProjectFactory.class.getName());     
    ...
    public Project loadProject(FileObject dir,  ProjectState state) throws IOException 
    {
        if (isProject(dir))
        {
            ...
            return new FacebookProject(dir, state, props);   
        }       
        return null;          
    }    
    ...
    public void saveProject(Project project) throws IOException, ClassCastException 
    {
        ...
        {            
            ...
            provider.getProperties().store(os, "Facebook project updated");
            os.close();   
        }  
    }     
}
