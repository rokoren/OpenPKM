...
public class LinkedInProjectFactory implements ProjectFactory
{
    public static final String PROJECT_FOLDER = "openpkm-linkedin-project"; 
    public static final String PROJECT_FILE   = "project.properties";      
    
    private static final Logger LOG = Logger.getLogger(LinkedInProjectFactory.class.getName());     
    ...
    public Project loadProject(FileObject dir,  ProjectState state) throws IOException 
    {
        if (isProject(dir))
        {
            ...
            return new LinkedInProject(dir, state, props);   
        }       
        return null;          
    }    
    ...
    public void saveProject(Project project) throws IOException, ClassCastException 
    {
        ...
        {            
            ...
            provider.getProperties().store(os, "LinkedIn project updated");
            os.close();   
        }  
    }      
}
