...
public class IconsProviderImpl implements IconsProvider
{
    ...
    @StaticResource()
    private static final String ICON_PROJECTS = "openpkm/core/resources/file_manager.png";      
    ...
    @StaticResource()
    public static final String ICON_BULLET_MAGNIFY = "openpkm/core/resources/bullet_magnify.png";       
