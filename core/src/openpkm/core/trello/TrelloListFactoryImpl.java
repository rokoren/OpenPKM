 ...
 * @author Rok Koren
 */
@ServiceProvider(service=TrelloListFactory.class)
public class TrelloListFactoryImpl implements TrelloListFactory
{            
    private static final Logger LOG = Logger.getLogger(TrelloListFactory.class.getName());    
