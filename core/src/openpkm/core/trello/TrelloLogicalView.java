 ...
 * @author Rok Koren
 */
public class TrelloLogicalView implements LogicalViewProvider
{
    private final TrelloProject project;

    public TrelloLogicalView(TrelloProject project)
    {
    ...
    public Node createLogicalView() 
    {
        ...
        return new TrelloNode(nodeOfProjectFolder, project);
    }
