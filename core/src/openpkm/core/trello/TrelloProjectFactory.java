...
public class TrelloProjectFactory implements ProjectFactory
{
    public static final String PROJECT_FOLDER = "openpkm-trello-project"; 
    public static final String PROJECT_FILE   = "project.properties";      
    
    private static final Logger LOG = Logger.getLogger(TrelloProjectFactory.class.getName());     
    ...
    public void saveProject(Project project) throws IOException, ClassCastException 
    {
        ...
        {            
            ...
            provider.getProperties().store(os, "Trello project updated");
            os.close();   
        }  
    }    
}
