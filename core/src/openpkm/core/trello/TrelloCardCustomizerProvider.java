 ...
 * @author Rok Koren
 */
public class TrelloCardCustomizerProvider implements CustomizerProvider
{
    public final TrelloCardProject project;

    public static final String CUSTOMIZER_FOLDER_PATH = "Projects/openpkm-trello-card-project/Customizer";

    public TrelloCardCustomizerProvider(TrelloCardProject project)
    {
