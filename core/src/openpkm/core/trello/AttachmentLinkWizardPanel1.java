 ...
 * @author Rok Koren
 */
public class AttachmentLinkWizardPanel1 implements WizardDescriptor.ValidatingPanel<WizardDescriptor>
{
    /**
     * The visual component that displays this panel. If you need to access the
     * component from this class, just use getComponent().
     */
    private AttachmentLinkVisualPanel1 component;
    ...
    @Override
    public AttachmentLinkVisualPanel1 getComponent() {
        if (component == null) {
            component = new AttachmentLinkVisualPanel1();
        }
        return component;
    }
    ...
    {
        if (getComponent().getAttachmentUrl().equals("")) 
        {
            throw new WizardValidationException(null, "URL can not be empty", null);
        }         
        if (getComponent().getAttachmentName().equals("")) 
        {
