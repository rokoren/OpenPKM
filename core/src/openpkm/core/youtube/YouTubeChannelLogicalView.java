 ...
 * @author Rok Koren
 */
public class YouTubeChannelLogicalView implements LogicalViewProvider
{
    private final YouTubeChannelProject project;

    public YouTubeChannelLogicalView(YouTubeChannelProject project)
    {
    ...
    public Node createLogicalView() 
    {
        ...
        return new YouTubeChannelNode(nodeOfProjectFolder, project);
    }
