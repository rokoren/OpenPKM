 ...
 * @author rok
 */
public class LiteratureNoteWizardPanel1 implements WizardDescriptor.ValidatingPanel<WizardDescriptor>
{
    /**
     * The visual component that displays this panel. If you need to access the
     * component from this class, just use getComponent().
     */
    private LiteratureNoteVisualPanel1 component;
    ...
    @Override
    public LiteratureNoteVisualPanel1 getComponent() 
    {
        if (component == null) 
        {
            component = new LiteratureNoteVisualPanel1();
        }
        return component;
    }
    ...
    public void storeSettings(WizardDescriptor descriptor) 
    {
        ...
        descriptor.putProperty(LiteratureNote.PROP_SUBTITLE, getComponent().getNoteSubtitle());
        descriptor.putProperty(LiteratureNote.PROP_AUTHOR_NAME, getComponent().getAuthorName());
