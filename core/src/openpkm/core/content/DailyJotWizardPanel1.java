 ...
 * @author Rok Koren
 */
public class DailyJotWizardPanel1 implements WizardDescriptor.ValidatingPanel<WizardDescriptor>
{
    /**
     * The visual component that displays this panel. If you need to access the
     * component from this class, just use getComponent().
     */
    private DailyJotVisualPanel1 component;
    ...
    @Override
    public DailyJotVisualPanel1 getComponent() 
    {
        if (component == null) 
        {
            component = new DailyJotVisualPanel1();
        }
        return component;
    }
    ...
    public void storeSettings(WizardDescriptor descriptor) 
    {
        ...
        descriptor.putProperty(TagsProvider.PROP_TAGS, new HashSet<String>(getComponent().getTags())); 
    }      
}
