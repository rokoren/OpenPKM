 ...
 * @author Rok Koren
 */
public class GitHubLogicalView implements LogicalViewProvider
{
    private final GitHubProject project;

    public GitHubLogicalView(GitHubProject project)
    {
    ...
    public Node createLogicalView() 
    {
        ...
        return new GitHubNode(nodeOfProjectFolder, project);
    }
