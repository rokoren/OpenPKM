 ...
 * @author Rok Koren
 */
public class GitHubCustomizerProvider implements CustomizerProvider
{
    public final GitHubProject project;

    public static final String CUSTOMIZER_FOLDER_PATH = "Projects/openpkm-github-project/Customizer";

    public GitHubCustomizerProvider(GitHubProject project)
    {
