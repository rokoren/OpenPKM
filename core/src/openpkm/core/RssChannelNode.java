 ...
 * @author Rok Koren
 */
public class RssChannelNode extends FilterNode implements ChangeListener, PropertyChangeListener
{
    private final RssChannelProject project;
    
    public RssChannelNode(Node node, RssChannelProject project) 
    {  
