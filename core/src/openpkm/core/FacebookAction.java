...
@Messages("CTL_FacebookAction=Add Facebook")
public class FacebookAction implements ActionListener
{
    private static final Logger LOG = Logger.getLogger(FacebookAction.class.getName());     
    
    private final DomainsProvider provider;

    public FacebookAction(DomainsProvider provider)
    {
    ...
    public void actionPerformed(ActionEvent evt)
    {
        ...
        panels.add(new FacebookWizardPanel1());
        ...
        { 
            ...
            User user = (User) wiz.getProperty("user"); 
