...
public class DomainSearchProvider implements SearchProvider 
{
    private static final Logger LOG = Logger.getLogger(DomainSearchProvider.class.getName()); 
    
    private final FilterTagsProvider filterTags; 
    
    public DomainSearchProvider() 
    {
