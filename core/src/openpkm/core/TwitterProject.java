 ...
 * @author Rok Koren
 */
public class TwitterProject implements Domain, TwitterUser, PropertiesProvider, Sources, SourceProviders, BatchUpdateSupport
{
    ...
    private static final Logger LOG = Logger.getLogger(TwitterProject.class.getName());        
    
    private static final RequestProcessor RP = new RequestProcessor(TwitterProject.class);   
    ...
    public TwitterProject(FileObject projectDir, ProjectState state, Properties props) 
    {
...
// TODO TwitterUser    
    ...
    {
        String string = props.getProperty(PROP_PROFILE_IMAGE_URL);
        if(string != null)
        {
            try
            {
    ...
    private final class TopComponentProviderImpl implements TopComponentProvider, MultiViewDescription, MultiViewElement
    {
        ...
        public JComponent getVisualRepresentation() 
        {
            ...
            if(provider != null)
            {
                try
                {
                    browser = provider.getCefClient().createBrowser(TwitterUser.X_URL + getUserName(), false, false);   
        ...
        public Lookup getLookup() 
        {
            return TwitterProject.this.getLookup();
        }        
...
// TODO ProjectInformation 
    ...
    {                     
        ...
        {  
            ...
            return provider.getIcon(IconsProvider.ICON.TWITTER);
        }
...
// TODO IconProvider    
    ...
    {        
        ...
        public void run() 
        {
            URL profileImageUrl = getProfileImageUrl();
...
// TODO RootProjectProvider     
    ...
    private final class RootProjectProviderImpl implements RootProjectProvider
    {
        ...
        {
            return Utils.getRootProject(TwitterProject.this);
        }         
    }
