 ...
 * @author Rok Koren
 */
public class LinkedInWizardPanel2 implements WizardDescriptor.ValidatingPanel<WizardDescriptor>
{
    private static final Logger LOG = Logger.getLogger(LinkedInWizardPanel2.class.getName()); 
