...
// @ActionID(category="...", id="openpkm.neo4j.Neo4jWizardAction")
// @ActionRegistration(displayName="Open Neo4j Wizard")
// @ActionReference(path="Menu/Tools", position=...)
public final class Neo4jWizardAction implements ActionListener {
