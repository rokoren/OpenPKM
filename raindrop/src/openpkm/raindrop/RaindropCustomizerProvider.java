 ...
 * @author Rok Koren
 */
public class RaindropCustomizerProvider implements CustomizerProvider
{
    public static final String CUSTOMIZER_FOLDER_PATH = "Projects/openpkm-raindrop-project/Customizer";
    
    private final RaindropProject project;

    public RaindropCustomizerProvider(RaindropProject project)
    {
    ...
    private class OKOptionListener implements ActionListener 
    {
        ...
        public void actionPerformed(ActionEvent e) 
        {
            ...
            {
                StatusDisplayer.getDefault().setStatusText("Modifying OpenPKM Raindrop Project: " + project.getTitle());                
            }
        }
    }     
}
