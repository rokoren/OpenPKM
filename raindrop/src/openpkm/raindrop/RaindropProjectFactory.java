...
public class RaindropProjectFactory implements ProjectFactory
{
    public static final String PROJECT_FOLDER = "openpkm-raindrop";     
    public static final String PROJECT_FILE   = "project.properties";
    
    private static final Logger LOG = Logger.getLogger(RaindropProjectFactory.class.getName());     
