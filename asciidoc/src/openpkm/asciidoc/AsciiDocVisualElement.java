...
public final class AsciiDocVisualElement extends JPanel implements MultiViewElement {

    private AsciiDocDataObject obj;
    private JToolBar toolbar = new JToolBar();
    private transient MultiViewElementCallback callback;

    public AsciiDocVisualElement(Lookup lkp) {
        obj = lkp.lookup(AsciiDocDataObject.class);
        assert obj != null;
        initComponents();
    }
