 ...
 * @author Rok Koren
 */
public class AsciidocTokenList implements TokenList 
{
    ...
    AsciidocTokenList(Document doc) {
        this.doc = doc;
        this.hidden = false;
    }
    ...
    public void setStartOffset(final int startOffset) {
        ...
        FileObject fileObject = FileUtil.getConfigFile("Spellcheckers/Asciidoc"); //NOI18N
